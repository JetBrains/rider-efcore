    ...
    protected fun Panel.createStartupProjectRow() {
        row("Startup project:") {
            iconComboBox(availableStartupProjects, { commonOptions.startupProject }, ::startupProjectSetter)
                ...
                .comment("Your project is not listed? <a href='https://plugins.jetbrains.com/plugin/18147-entity-framework-core-ui/f-a-q#why-i-cant-see-my-project-in-a-startup-projects-field'>Help</a>")
        }
    }
